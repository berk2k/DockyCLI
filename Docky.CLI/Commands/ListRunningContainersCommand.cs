...
{
    public class ListRunningContainersCommand : Command<ListRunningContainersCommand.Settings>
    {
        private readonly IDockerService _dockerService;
        private readonly OutputRenderer _renderer;

        public ListRunningContainersCommand(IDockerService dockerService, OutputRenderer renderer)
        {
